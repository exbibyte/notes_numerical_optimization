...
\end{enumerate}
  ...
  Idea: add a weighted quadratic penalty term per constraint to the objective. Form a sequence of probems with increasing weights to penalty terms.\\
  ...
  \subsubsection{Linearly Constrained}
  TODO
